...
You can pass pass arguments to this bash script defining which one of the steps (downsampling: **d**, preprocessing: **p**, feature representation: **f**, MAP scores: **m**, kaggle results: **k**, yaml filepath: **y**) you want to perform.
...
Here is an example of how to execute the script: 
    ...
    bash run.pipeline.sh -d true -p true -f true -m true -k true -y filepath
